                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="3u 12u$(large)">
                                        <a href="displaynew.php" class="btn btn-danger" style="text-decoration: none;">Orders</a>
                                    </div>
                                    <div class="3u 12u$(large)">
                                        <a href="profileEditnew.php" class="btn btn-danger" style="text-decoration: none;">Update/Delete</a>
                                    </div>
