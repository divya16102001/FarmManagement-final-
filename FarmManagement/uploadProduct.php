		...
		if(in_array($picActualExt, $allowed))
		{
			if($picError === 0)
			{
				...
				if($result)
				{
					...
					header("Location: Login/insertconfirm.php");
				}
				else
				{
					//die("bad");
...
<html lang="en">
	...
	<body>
		...
		<!-- One -->
			...
			<div class="row">
				<div class="col-sm-6">
					  <input type="number" name="price" id="price" value="" placeholder="Price" style="background-color:white;color: black;" min="1" required />
				</div>
				<div class="col-sm-6">
